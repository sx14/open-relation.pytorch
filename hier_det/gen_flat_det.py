...
def parse_args():
    ...
    """
    parser = argparse.ArgumentParser(description='generate flat result')
...
if __name__ == '__main__':
    ...
    fasterRCNN = vgg16_det(objnet.get_raw_labels())
    ...
    for i, img_id in enumerate(det_roidb.keys()):
        ...
        with torch.no_grad():
            ...
            rois_label = fasterRCNN(im_data, im_info, im_boxes[:, :, :5], num_boxes, False)
