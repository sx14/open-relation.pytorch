...
with open('predication_result.data', 'rb') as f:
    preds = pickle.load(f)
...
with open('pre_box_label_vrd_dr.bin', 'wb') as f:
    pickle.dump(preds, f)



with open('detection_result.data', 'rb') as f:
    preds = pickle.load(f)
...
with open('rela_box_label_vrd_dr.bin', 'wb') as f:
    pickle.dump(preds, f)
