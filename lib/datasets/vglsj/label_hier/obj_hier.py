...
raw_label_path = os.path.join(PROJECT_ROOT, 'data', 'VGlsjdevkit2007', 'VOC2007', 'object_labels.txt')
raw2wn_path = os.path.join(PROJECT_ROOT, 'data', 'VGlsjdevkit2007', 'VOC2007', 'object_label2wn.txt')
