...
from hier_rela.visual.visual_sampler import sampler
...
if __name__ == '__main__':
    ...
    params = []
    for key, value in hierVis.named_parameters():
    ...
    if args.resume:
        load_name = os.path.join(output_dir,
                                 'hier_rela_vis_{}_{}_{}_{}.pth'.format(args.checksession, args.checkepoch,
    ...
    if args.mGPUs:
        hierVis = nn.DataParallel(hierVis)
    ...
    for epoch in range(args.start_epoch, args.max_epochs + 1):
        ...
        if epoch % 5 == 0:
            save_name = os.path.join(output_dir,
                                     'hier_rela_vis_{}_{}_{}_{}.pth'.format(args.session, epoch, step, args.dataset))
            save_checkpoint({
